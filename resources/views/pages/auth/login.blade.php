...
<p class="text-on-surface-variant font-medium">Enter your details to continue your journey.</p>
</div>
...
<span class="text-xs font-bold uppercase tracking-wider text-on-surface-variant">Patient</span>
</label>
<label class="relative flex flex-col items-center justify-center p-4 rounded-2xl border-2 border-surface-container-high cursor-pointer hover:bg-surface-container-low transition-all group has-[:checked]:border-primary has-[:checked]:bg-primary-fixed/30">
...
<p class="text-on-surface-variant text-sm font-medium">
                                ...
                                <a class="text-primary font-bold hover:underline transition-all" href="{{ route('register') }}">Create Account</a>
</p>
</div>
</form>
</div>
