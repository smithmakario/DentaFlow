...
<div class="absolute top-1/2 left-0 w-full h-1 bg-primary -translate-y-1/2 z-0 transition-all duration-500"></div>
<!-- Step 1: Active -->
...
<span class="mt-2 font-label-md text-on-surface-variant">Subscriptions</span>
</div>
<!-- Step 4: Upcoming -->
<div class="relative z-10 flex flex-col items-center">
<div class="w-10 h-10 rounded-full bg-primary text-on-primary flex items-center justify-center font-bold shadow-lg">4</div>
<span class="mt-2 font-label-md text-primary">Primary Admin</span>
</div>
</div>
</div>
...
<h3 class="font-h3 text-on-surface">Step 5: Primary Admin</h3>
...
<input class="w-full px-md py-sm rounded-lg border border-outline text-body-md focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all" placeholder="********" type="password"/>
</div>
</div>
<!-- Right: Logo Upload -->
