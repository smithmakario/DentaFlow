...
<a class="flex items-center gap-3 px-4 py-3 text-white bg-blue-600 rounded-lg mx-2 border-l-4 border-white translate-x-1 transition-all duration-200" href="#">
